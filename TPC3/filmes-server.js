...
<html>
    ...
    filmes.forEach(film => {
        ...
        <tr>
            ...
            <td>
            `
            var atores = film.cast
            atores.forEach(ator => {
                pagHTML += ` | <a href='/actors/${ator}'>${ator}</a> |  `
            })
            pagHTML += `</td>

            <td>
            `
            var generos = film.genres
            generos.forEach(gen => {
                pagHTML += ` | <a href='/genres/${gen}'>${gen}</a> |  `
            })
            pagHTML += `</td>  
        </tr>
        `
    ...
    <body>
        <div class="w3-card-4">
            ...
            pagHTML += `</div>
              ...
              <footer class="w3-container w3-red">
                <h5>Generated by EngWeb2024 [<a href="/filmes"> Voltar à lista]</h5>
              </footer>
...
<html>
    ...
    generos.forEach(genre => {
        pagHTML += `
        <tr>
            <td><a href='/genres/${genre.id}'>${genre.id}</a></td>
    ...
    <body>
        <div class="w3-card-4">
            ...
            pagHTML += `</div>
              ...
              <footer class="w3-container w3-red">
                <h5>Generated by EngWeb2024 [<a href="/genres"> Voltar à lista]</h5>
              </footer>
...
<html>
    ...
    atores.forEach(actor => {
        pagHTML += `
        <tr>
            <td><a href='/actors/${actor.id}'>${actor.id}</a></td>
    ...
    <body>
        <div class="w3-card-4">
            ...
            pagHTML += `</div>
              ...
              <footer class="w3-container w3-red">
                <h5>Generated by EngWeb2024 [<a href="/actors"> Voltar à lista]</h5>
              </footer>
...
http.createServer(function (req, res) {
    ...
    var regexgenero = /^\/genres\/\w+$/ 
    var regexatores = /^\/actors\/\w+/ 
